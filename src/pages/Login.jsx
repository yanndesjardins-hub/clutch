...
const RADIO = ({ name, value, checked, onChange, label }) => (
  <label style={{ display:'flex', alignItems:'center', gap:8, cursor:'pointer', fontSize:14, color: checked ? '#fff' : 'var(--text2)' }}>
...
export default function Login() {
  ...
  function signupValid() {
    return firstName.trim() && email.trim() && pwd.length >= 6
    ...
    <div style={{ minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', padding:'20px' }}>
      <div style={{ width:'100%', maxWidth:400 }}>
        ...
        <div className="text-center" style={{ marginBottom:32 }}>
          ...
          <p style={{ color:'var(--text3)', fontSize:12, letterSpacing:3 }}>NBA PLAYOFFS 2026</p>
        </div>
        ...
        <div className="card fade-up">
          ...
          <form onSubmit={submit} style={{ display:'flex', flexDirection:'column', gap:14 }}>
            ...
            {mode === 'signup' && (<>
              ...
              <div>
                <label className="label">Do you play basketball? *</label>
              ...
              <div>
                <label className="label">Your favorite team? (optional)</label>
                <input className="input" type="text" placeholder="e.g. Boston Celtics"
            ...
            {mode === 'signup' && (
              <div className="checkbox-row">
                ...
                <label htmlFor="consent">
                  I agree to receive email communications from the team that created this game regarding basketball (news, events). I can unsubscribe at any time via the link included in each email. *
                </label>
              </div>
            )}
